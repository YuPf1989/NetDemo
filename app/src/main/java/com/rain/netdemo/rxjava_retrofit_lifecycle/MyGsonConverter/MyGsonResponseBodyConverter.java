package com.rain.netdemo.rxjava_retrofit_lifecycle.MyGsonConverter;
...
import com.rain.netdemo.rxjava_retrofit_lifecycle.Exception.ApiException;
...
//        ByteArrayInputStream bis = new ByteArrayInputStream(response.getBytes());// 是最外层的数据
