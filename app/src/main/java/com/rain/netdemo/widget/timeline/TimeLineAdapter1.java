...
import com.rain.netdemo.utils.VectorDrawableUtils;
 ...
 */
public class TimeLineAdapter1 extends RecyclerView.Adapter<TimeLineViewHolder> {

    private List<TimeLineModel> mFeedList;
    private Context mContext;
    private LayoutInflater mLayoutInflater;

    public TimeLineAdapter1(List<TimeLineModel> feedList) {
        mFeedList = feedList;
    }
